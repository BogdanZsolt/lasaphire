...
<section class="home-subscribe">
	<div class="container">
		<div class="home-subscribe__message">
			<p class="home-subscribe__text"><?php esc_html_e( 'Be the first to find out about new products, events and news at La Saphire', 'lasaphire' ); ?></p>
		</div>
		<form id="home-subscribe">
			<div class="home-form__row">
				<div class="home-form__group">
					<input type="text" class="form-control" name="name" id="name" placeholder="<?php esc_html_e( 'How to call...', 'lasaphire' ); ?>" required>
				</div>
				<div class="home-form__group">
					<input type="email" class="form-control" name="email" id="email" placeholder="<?php esc_html_e( 'Email...', 'lasaphire' ); ?>" required>
				</div>
				<div class="col-md-2">
					<button type="submit" class="btn-alt btn-sm-alt btn-light"><?php esc_html_e( 'subscribe', 'lasaphire' ); ?></button>
				</div>
			</div>
