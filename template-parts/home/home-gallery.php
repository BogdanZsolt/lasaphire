	...
	<div class="container">
		...
		<?php
			for ($i=1; $i < 9; $i++) {
				...
				if( $id ){
					$src = wp_get_attachment_image_url(get_theme_mod( 'set_gallery_image' . $i ), 'woocommerce_thumbnail', false);
				...
				?>
				<img class="<?php echo 'zoom-img item-' . $i; ?>" data-imagesrc="<?php echo esc_url($data_src); ?>" src="<?php echo esc_url($src); ?>" alt="La Saphire Photo">
				<?php
			}
		?>
		</div>
