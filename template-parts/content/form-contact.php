<form id="contact-email-form">
 <div class="form-group">
  ...
  <input type="text" class="form-control" id="name" name="name"
   placeholder="<?php _e( 'Enter Your Name...', 'lasaphire' ); ?>" required>
 </div>
 <div class="form-group">
  <!-- <label for="email"><?php _e( 'Email address', 'lasaphire' ); ?></label> -->
  <input type="email" class="form-control" id="email" name="email" aria-describedby="emailHelp"
   placeholder="<?php _e( 'Enter Your email...', 'lasaphire' ); ?>" required>
  <small id="emailHelp"
   class="form-text text-muted"><?php _e( 'We′ll never share your email with anyone else.', 'lasaphire' ); ?></small>
 </div>
 <div class="form-group">
