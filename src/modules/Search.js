...
class Search {
	...
	constructor() {
		...
		this.btnText = {
			products: lasaphireData.productsName,
			ingredients: lasaphireData.ingredientsName,
			posts: lasaphireData.postsName,
			pages: lasaphireData.pagesName,
			faqs: lasaphireData.faqsName,
		};
	}
	...
	resultSelect() {
		setTimeout(() => {
			this.resultButtons =
				this.searchOverlay.querySelectorAll(".btn-normal-search");
